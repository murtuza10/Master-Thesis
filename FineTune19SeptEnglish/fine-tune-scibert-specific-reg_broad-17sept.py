...
aug_train = augment_dataset_controlled(combined_dataset, augmentation_ratio=3.0)
...
def objective(trial):
    ...
    training_args = TrainingArguments(
        output_dir=f"/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/Scibert-results-English-3/hyperparameter_search_regularized/trial_{trial.number}",
...
final_training_args = TrainingArguments(
    output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/Scibert-results-English-3/results/Scibert_English_final_model_regularized_3",
...
final_trainer.save_model("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/scibert_final_english_model_regularized_saved_broad-3")
tokenizer.save_pretrained("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/scibert_final_english_model_regularized_saved_broad-3")
...
print("Final model saved to /lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/scibert_final_english_model_regularized_saved_broad-3")
print("="*80)