...
def objective(trial):
    ...
    training_args = TrainingArguments(
        output_dir=f"/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-english-results-broad_3.0/hyperparameter_search_regularized/trial_{trial.number}",
        eval_strategy="epoch",
        save_strategy="epoch",
...
final_training_args = TrainingArguments(
    output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-english-results-broad_3.0-1/results/final_model_regularized_21",
    run_name="agribert-english-regularized-training",
    eval_strategy="epoch",
    save_strategy="epoch",
    load_best_model_at_end=True,
    metric_for_best_model="f1",
...
final_trainer.save_model("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-english_final_model_regularized_saved_broad_3.0-1")
tokenizer.save_pretrained("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-english_final_model_regularized_saved_broad_3.0-1")
...
print("Final model saved to ./results/agribert-english_final_model_regularized_saved_broad_3.0-1")
print("="*80)