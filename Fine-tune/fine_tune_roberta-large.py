...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/xlm_roberta_ner_model_5th_Sept_Specific",
        eval_strategy="epoch",
        save_strategy="epoch", 
        logging_dir="./logs",
        run_name="xlm-roberta-large_optuna_tuning_5th_Sept_Specific",
    ...
    best_args = TrainingArguments(
        output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/xlm_roberta_ner_model_5th_Sept_Specific_best",
        eval_strategy="epoch",
        save_strategy="epoch", 
        logging_dir="./logs_best",
        run_name="xlm-roberta-large_best_run_5th_Sept_Specific",
