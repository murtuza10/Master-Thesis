...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        ...
        save_strategy="epoch", 
        logging_dir="./logs",
        run_name="xlm_roberta_optuna_tuning_2nd_September",
        ...
        label_smoothing_factor=0.1,      # Helps with noisy/ambiguous labels
        lr_scheduler_type="cosine",      # Or "polynomial"
    )
    ...
    best_args = TrainingArguments(
        ...
        run_name="xlm_roberta_best_run_2nd_September",
