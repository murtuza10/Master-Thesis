...
augmented_train_dataset = augment_dataset(train_dataset, augmentation_ratio=0.3)
...
def objective(trial):
    ...
    warmup_ratio = trial.suggest_float("warmup_ratio", 0.1, 0.3)  # Use ratio instead of steps
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=trial.suggest_int("num_train_epochs", 3, 8),  # Fewer epochs
...
study.optimize(objective, n_trials=15)  # Reduced trials for faster testing
...
final_trainer.save_model("./results/final_model_regularized_saved")
tokenizer.save_pretrained("./results/final_model_regularized_saved")
