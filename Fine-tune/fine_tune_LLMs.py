...
if __name__ == "__main__":
    ...
    config.num_labels = len(label_list)  # Ensure this is set
    ...
    def model_init():
        ...
        peft_config = LoraConfig(
            task_type=TaskType.TOKEN_CLS,   # Use TOKEN_CLS for token classification (NER)
            r=8,                            # LoRA rank
        ...
        lora_model.print_trainable_parameters()  # Optional: sanity check
    ...
    training_args = TrainingArguments(
        ...
        save_strategy="epoch", 
        logging_dir="./logs",
        run_name=f"{model_name}_optuna_tuning",
    ...
    results_lines.append("Best trial:", best_trial)
    ...
    best_args = TrainingArguments(
        ...
        run_name=f"{model_name}_best_run",
    ...
    results_lines.append(f"\n📊 Final Test Evaluation: {results.metrics}")
