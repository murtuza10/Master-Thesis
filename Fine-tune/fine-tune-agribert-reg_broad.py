...
# Load datasets
train_dataset = Dataset.from_json("/home/s27mhusa_hpc/Master-Thesis/Dataset19September/NER_dataset_sentence_train_stratified_nodupl.json")
val_dataset   = Dataset.from_json("/home/s27mhusa_hpc/Master-Thesis/Dataset19September/NER_dataset_sentence_val_stratified_nodupl.json")
test_dataset  = Dataset.from_json("/home/s27mhusa_hpc/Master-Thesis/Dataset19September/Test_NER_dataset_nodupl.json")
...
def objective(trial):
    ...
    training_args = TrainingArguments(
        output_dir=f"/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-results-broad_14-3/hyperparameter_search_regularized/trial_{trial.number}",
...
final_training_args = TrainingArguments(
    output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert-results-broad_14-3/results/final_model_regularized_14",
    run_name="agribert-regularized-training",
    eval_strategy="epoch",
    save_strategy="epoch",
    load_best_model_at_end=True,
    metric_for_best_model="f1",
...
final_trainer.save_model("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert_final_model_regularized_saved_broad_14-3")
tokenizer.save_pretrained("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/agribert_final_model_regularized_saved_broad_14-3")
...
print("Final model saved to ./results/agribert_final_model_regularized_saved_broad_14-3")
print("="*80)