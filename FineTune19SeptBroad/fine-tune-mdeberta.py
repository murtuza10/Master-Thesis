...
def objective(trial):
    ...
    training_args = TrainingArguments(
        output_dir=f"/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/mdeberta-new-results-broad_2.0/hyperparameter_search_regularized/trial_{trial.number}",
...
final_training_args = TrainingArguments(
    output_dir="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/mdeberta-new-results-broad_2.0/results/final_model_regularized_14",
    run_name="mdeberta-new-regularized-training",
    eval_strategy="epoch",
    save_strategy="epoch",
    load_best_model_at_end=True,
    metric_for_best_model="f1",
...
final_trainer.save_model("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/mdeberta-new_final_model_regularized_saved_broad_2.0")
tokenizer.save_pretrained("/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/mdeberta-new_final_model_regularized_saved_broad_2.0")
...
print("Final model saved to ./results/mdeberta-new_final_model_regularized_saved_broad_2.0")
print("="*80)