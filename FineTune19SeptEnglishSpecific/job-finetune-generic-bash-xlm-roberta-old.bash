...
LOG_DIR="/home/s27mhusa_hpc/Master-Thesis/OutputNewDatasets20thSeptemberFineTuneEnglish/job_monitor_logs_${MODEL_NAME}_${SLURM_JOB_ID}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
INTERVAL=30
...
# === Run Main Script ===
python /home/s27mhusa_hpc/Master-Thesis/FineTune19SeptEnglish/fine_tune_xlm_roberta_old.py
