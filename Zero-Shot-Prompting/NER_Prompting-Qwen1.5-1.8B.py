...
# Step 1: Load Qwen 1.5-1.8B Model and Tokenizer
def load_qwen_model(model_path):
    print("Loading Qwen 1.5-1.8B model and tokenizer from local directory...")
...
if __name__ == "__main__":
    ...
    output_dir = "/home/s27mhusa_hpc/pilot-uc-textmining-metadata/data/Bonares/output/filtered_df_soil_crop_year_LTE_test_annotated_Qwen1.5-1.8B"  # Change to the desired output directory path
    local_model_path = "/lustre/scratch/data/s27mhusa_hpc-ner_model_data/Qwen1.5-1.8B"
