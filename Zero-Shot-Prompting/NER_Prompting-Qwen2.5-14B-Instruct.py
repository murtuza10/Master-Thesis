...
# Step 1: Load Qwen 2.5-14B Model and Tokenizer
def load_qwen_model(model_path):
    print("Loading Qwen 2.5-14B model and tokenizer from local directory...")
    ...
    print("Qwen 2.5-14B model and tokenizer loaded from local path.")
...
if __name__ == "__main__":
    ...
    output_dir = "/home/s27mhusa_hpc/pilot-uc-textmining-metadata/data/Bonares/output/Results/filtered_df_soil_crop_year_LTE_test_annotated_Qwen2.5-14B-Instruct"  # Change to the desired output directory path
    local_model_path = "/lustre/scratch/data/s27mhusa_hpc-ner_model_data/Qwen2.5-14B-Instruct"
