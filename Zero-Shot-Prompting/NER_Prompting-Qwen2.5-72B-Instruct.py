...
def load_qwen_model(model_path):
    print("Loading Qwen 2.5-72B model and tokenizer from local directory...")
    ...
    print("Qwen 2.5-72B model and tokenizer loaded from local path.")
    return model, tokenizer


# Step 3: Perform NER with Qwen 2.5-72B
