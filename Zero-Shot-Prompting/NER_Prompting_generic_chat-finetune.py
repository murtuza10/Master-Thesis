...
def process_text_files(input_path, model, tokenizer, output_dir, max_length):
    os.makedirs(output_dir, exist_ok=True)
    
    for filename in os.listdir(input_path):
        if filename.endswith(".txt"):
            input_text_path = os.path.join(input_path, filename)
...
def main():
    ...
    parser.add_argument("--input_path", required=True, help="Directory containing input text files.")
    ...
    process_text_files(args.input_path, model, tokenizer, args.output_dir, args.max_length)
