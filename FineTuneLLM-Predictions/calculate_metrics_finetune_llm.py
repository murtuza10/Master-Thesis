...
def evaluate_predictions_from_json(model_name, text_json_path, pred_json_path, gold_json_path):
    ...
    # Output paths
    output_base = "/home/s27mhusa_hpc/Master-Thesis/Evaluation_Results/FineTuneSentenceLevelResults-30July"
...
if __name__ == "__main__":
    ...
    evaluate_predictions_from_json(
        ...
        text_json_path="/home/s27mhusa_hpc/Master-Thesis/FineTuneLLM-Predictions/Test_ner_dataset_sentence_text_entity.json",
        pred_json_path="/home/s27mhusa_hpc/Master-Thesis/FineTuneLLM-Predictions/Test_predictions_FineTune_Llama3.1-8B-Instruct_extracted.json",
        gold_json_path="/home/s27mhusa_hpc/Master-Thesis/FineTuneLLM-Predictions/Test_gold_FineTune_Llama3.1-8B-Instruct_extracted.json"
    )