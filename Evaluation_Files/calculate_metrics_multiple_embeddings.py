...
def evaluate_all(model_name, input_text_dir, input_annot_dir, input_annot_dir_json, start, xmi_dir):
    ...
    results_output_path = f"/home/s27mhusa_hpc/Master-Thesis/Evaluation_Results/Final_TestFiles_27thAugust_FewShotTest_Embeddings/ner_evaluation_results_{model_name}_{start}_shot.txt"
    stats_output_path = f"/home/s27mhusa_hpc/Master-Thesis/Evaluation_Results/Final_TestFiles_27thAugust_FewShotTest_Embeddings/Stats/ner_evaluation_stats_{model_name}_{start}_shot.txt"
...
if __name__ == "__main__":
    ...
    input_annot_dir = f"/home/s27mhusa_hpc/Master-Thesis/Results/Results_TestFiles_11thAugust/LLM_annotated_Llama-3.1-8B-Instruct_1shot"
    input_annot_dir_json = f"/home/s27mhusa_hpc/Master-Thesis/Results/Results_TestFiles_11thAugust_json/LLM_annotated_Llama-3.1-8B-Instruct_1shot"
