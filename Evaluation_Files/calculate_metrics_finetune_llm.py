...
def evaluate_predictions_from_json(model_name, text_json_path, pred_json_path, gold_json_path):
    ...
    comparison_output_path = f"{output_base}/Comparisons/Qwen2.572B-Pretrianed-Comprison/ner_comparison_{model_name}.jsonl"
...
if __name__ == "__main__":
    ...
    evaluate_predictions_from_json(
        ...
        text_json_path="/home/s27mhusa_hpc/Master-Thesis/FinalDatasets-21July/Test_ner_dataset_sentence_text_entity.json",
        pred_json_path="/home/s27mhusa_hpc/Master-Thesis/FinalDatasets-21July/Test_predictions_Pretrained_Qwen2.5-72B_extracted.json",
        gold_json_path="/home/s27mhusa_hpc/Master-Thesis/FinalDatasets-21July/Test_gold_extracted.json"
    )