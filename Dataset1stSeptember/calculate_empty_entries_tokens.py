...
# Load your JSON data
with open('/home/s27mhusa_hpc/Master-Thesis/Dataset1stSeptember/Test_NER_dataset.json', 'r') as f:
    data = json.load(f)
...
# Save result
with open('/home/s27mhusa_hpc/Master-Thesis/Dataset1stSeptember/Test_NER_dataset_filtered.json', 'w') as f:
