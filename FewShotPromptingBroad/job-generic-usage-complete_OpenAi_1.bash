...
OUTPUT_DIR="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting/LLM_annotated_${MODEL_NAME}_1shot"
OUTPUT_DIR_JSON="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting_json/LLM_annotated_${MODEL_NAME}_1shot"
...
LOG_DIR="/home/s27mhusa_hpc/Master-Thesis/FinalOutput-22thSeptember-TwoShotPrompting_Final/job_monitor_logs_TestFiles${MODEL_NAME}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
INTERVAL=1
...
# === Run Main Script ===
python /home/s27mhusa_hpc/Master-Thesis/FewShotPromptingBroad/NER_Prompting_chat_openAI_1.py \
  --input_dir "$INPUT_DIR" \
