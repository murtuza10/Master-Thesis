...
OUTPUT_DIR="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting/LLM_annotated_${MODEL_NAME}_3shot"
OUTPUT_DIR_JSON="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting_json/LLM_annotated_${MODEL_NAME}_3shot"
MODEL_PATH="/lustre/scratch/data/s27mhusa_hpc-murtuza_master_thesis/${MODEL_NAME}"
START=3

module load CUDA/22.6.0
module load sysstat
...
LOG_DIR="/home/s27mhusa_hpc/Master-Thesis/FinalOutput-22thSeptember-ThreeShotPrompting_Final/job_monitor_logs_TestFiles${MODEL_NAME}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
INTERVAL=1
...
# === Run Main Script ===
python /home/s27mhusa_hpc/Master-Thesis/FewShotPromptingBroad/NER_Prompting_chat_openAI_3.py \
  --input_dir "$INPUT_DIR" \
...
EXCEL_PATH="/home/s27mhusa_hpc/Master-Thesis/Evaluation_Results/Final_TestFiles_22thSeptember_FewShotTest_Broad_Count/ner_evaluation_results_${MODEL_NAME}_${START}_shot.xlsx"
