...
# Load your JSON data
with open('/home/s27mhusa_hpc/Master-Thesis/NewDatasets27August/Train_ner_dataset_sentence.json', 'r') as f:
    data = json.load(f)
...
# Save result
with open('/home/s27mhusa_hpc/Master-Thesis/NewDatasets27August/Train_ner_dataset_sentence_filtered.json', 'w') as f:
