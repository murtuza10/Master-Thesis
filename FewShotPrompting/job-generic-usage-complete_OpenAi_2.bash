...
OUTPUT_DIR="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting_Specific/LLM_annotated_${MODEL_NAME}_2shot"
OUTPUT_DIR_JSON="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22thSeptember_Prompting_Specific_json/LLM_annotated_${MODEL_NAME}_2shot"
...
LOG_DIR="/home/s27mhusa_hpc/Master-Thesis/FinalOutput-22thSeptember-TwoShotPrompting_Final_Specific/job_monitor_logs_TestFiles${MODEL_NAME}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
INTERVAL=1
...
# === Run Main Script ===
python /home/s27mhusa_hpc/Master-Thesis/FewShotPrompting/NER_Prompting_chat_openAi_2.py \
  --input_dir "$INPUT_DIR" \
