...
# Load your JSON data
with open('/home/s27mhusa_hpc/Master-Thesis/Dataset19September/Train_NER_dataset_Specific_nodupl.json', 'r') as f:
    data = json.load(f)
...
# Save result
with open('/home/s27mhusa_hpc/Master-Thesis/Dataset19September/Train_NER_dataset_Specific_filtered_nodupl.json', 'w') as f:
