...
# Load your JSON data
with open('/home/s27mhusa_hpc/Master-Thesis/DatasetsFinalPredictions/NER_dataset.json', 'r') as f:
    data = json.load(f)
...
# Save result
with open('/home/s27mhusa_hpc/Master-Thesis/DatasetsFinalPredictions/NER_dataset_filtered.json', 'w') as f:
