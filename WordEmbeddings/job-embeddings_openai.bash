...
#SBATCH --output=/home/s27mhusa_hpc/Master-Thesis/FinalOutput-22September-EmbeddingsSpecific/gpu_job_TestFiles_GPT5_Embeddings_Specific_%j_22September.out

MODEL_NAME=$1
EXAMPLES=$2

INPUT_DIR="/home/s27mhusa_hpc/Master-Thesis/Text_Files_Test_Data"
OUTPUT_DIR="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22September_Embeddings_Speciifc/LLM_annotated_${MODEL_NAME}_${EXAMPLES}shot"
OUTPUT_DIR_JSON="/home/s27mhusa_hpc/Master-Thesis/Results/FinalResults_TestFiles_22September_Embeddings_Specific_json/LLM_annotated_${MODEL_NAME}_${EXAMPLES}shot"
...
LOG_DIR="/home/s27mhusa_hpc/Master-Thesis/FinalOutput-22September-EmbeddingsSpecific/job_monitor_logs_TestFiles${MODEL_NAME}_$(date +%Y%m%d_%H%M%S)_${EXAMPLES}shot"
mkdir -p "$LOG_DIR"
INTERVAL=1
...
# === Run Main Script ===
python ner_embeddings_pipeline-openai.py \
  --dataset /home/s27mhusa_hpc/Master-Thesis/NewDatasets27August/Train_ner_dataset_sentence_filtered_input_output.jsonl \
  --index /home/s27mhusa_hpc/Master-Thesis/WordEmbeddings/ner_embeddings.index \
...
EXCEL_PATH="/home/s27mhusa_hpc/Master-Thesis/Evaluation_Results/Final_TestFiles_22September_FewShotTest_Embeddings_Specific/ner_evaluation_results_${MODEL_NAME}_${EXAMPLES}_shot.xlsx"
